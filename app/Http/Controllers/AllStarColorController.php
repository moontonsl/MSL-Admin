...
use App\Models\AllStarColorSubmission;
use Illuminate\Support\Facades\Log;

class AllStarColorController extends Controller
{
    public function store(Request $request)
    {
        try {
            ...
            Log::error('AllStarColor Submission Error: ' . $e->getMessage());
