...
export default function MslEventCreate() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.msl-events.store'), {
            forceFormData: true,
        });
    };
        ...
        <AdminLayout>
            ...
            <div className="py-12">
                <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <Card>
                        <div className="p-6">
                            <h2 className="text-2xl font-bold text-gray-900 mb-6">Create New MSL Event Card</h2>
                    
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                        <h3 className="text-lg font-semibold text-blue-800 mb-2">📋 Event Card Management</h3>
                        <p className="text-blue-700 text-sm">
                            This form creates event cards for the Events page. You only need to provide:
                        </p>
