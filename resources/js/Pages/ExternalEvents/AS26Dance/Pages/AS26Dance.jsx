...
export default function ASDance() {
  const initialForm = {
    name: '',
    school: '',
    uid: '',
  ...
  return (
    <MainLayout>
      <Head title="AS Seapop DANCE CHALLENGE UGC" />
      <Helmet>
        <title>AS Seapop DANCE CHALLENGE UGC | MSL Philippines</title>
        <link
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="text-center mb-2 flex flex-col items-center">
                <h2 className="text-base sm:text-xl font-black text-white mb-1">
                  AS Seapop DANCE CHALLENGE UGC Submission
                </h2>
                <p className="text-[11px] sm:text-sm text-center" style={{ color: SECONDARY_LIGHT }}>
                  Please fill out the submission details below for the MLBB Seapop Dance Challenge.
                </p>
              </div>
              ...
              <div className="rounded-2xl p-4 text-white text-center shadow-inner flex flex-col items-center" style={{ backgroundColor: PRIMARY }}>
                <h3 className="text-[10px] font-bold uppercase tracking-widest opacity-90 mb-2">
                  Required Hashtags
                </h3>
                <p className="w-full font-mono text-xs sm:text-sm font-bold break-words leading-relaxed text-center">
                  #MLBBALLSTAR #MSLPhilippines #MSLSeaPop #MobileLegendBangBang
                </p>
              </div>
            ...
            <div className="w-[95%] sm:w-full max-w-2xl overflow-hidden rounded-2xl sm:rounded-3xl bg-white text-black shadow-2xl flex flex-col max-h-[90vh] sm:max-h-[85vh]">
              <div className="px-6 py-6 bg-white border-b border-gray-100 flex flex-col items-center text-center relative">
                ...
                <h2 className="text-xl sm:text-2xl font-black text-gray-900 leading-tight">
                  How to Join AS Seapop DANCE CHALLENGE UGC
                </h2>
                <p className="w-full text-gray-500 text-xs sm:text-sm mt-2 px-4">
                  Follow these steps to qualify for the MLBB Seapop Dance Challenge
                </p>
              </div>
              ...
              <div className="overflow-y-auto p-4 sm:p-6 flex-1">
                <div className="grid gap-4 mb-4">
                  <MechanicCard
                    num="1"
                    title="Follow the official page"
                    body="Follow the official page of Moonton Student Leader."
                  />
                  <MechanicCard
                    num="2"
                    ...
                    body={
                      <>
                        Watch the official Dance Challenge video,{" "}
                        <a
                          href="https://drive.google.com/drive/folders/1r08_bF9xoh9ayS_E4RCxPzceFi3aybXR?usp=drive_link"
                          target="_blank"
                  ...
                  <MechanicCard
                    num="3"
                    title="Recreate the choreography"
                    body="Recreate the ALLSTAR Dance Choreography"
                  />
                  <MechanicCard
                    num="4"
                    title="Post your entry"
                    body="Post your entry on TikTok /Facebook Reels"
                  />
                  <MechanicCard
                    num="5"
                    title="Use official sound"
                    body="Use the official sound/music."
                  />
                  <MechanicCard
                    num="6"
                    title="Include hashtags"
                    body="Include the hashtags: #MLBBALLSTAR #MSLPhilippines #MSLSeaPop #MobileLegendBangBang"
                  />
                  <MechanicCard
                    num="7"
                    title="Tag the official page"
                    body="Tag the official page in your post."
                  />
                  <MechanicCard
                    num="8"
                    title="Submit"
                    body="Submit through this page or at /AS26Dance"
                  />
                </div>
                ...
                <div className="rounded-2xl bg-[#0D9488] p-4 text-white text-center shadow-inner mt-4">
                  ...
                  <p className="flex flex-wrap justify-center gap-1 font-mono text-xs sm:text-sm font-bold leading-relaxed">
                    <span>#MLBBALLSTAR</span>
                    <span>#MSLPhilippines</span>
                    <span>#MSLSeaPop</span>
                    <span>#MobileLegendBangBang</span>
                  </p>
                </div>

                <div className="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-2xl">
                  <p className="text-yellow-800 text-sm font-semibold">
                    NOTE: The dance video should be authentic and raw; only minimal edits are accepted.
                  </p>
                </div>
              </div>
          ...
          <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-[10000] p-4">
            <div className="bg-white rounded-xl p-6 sm:p-8 text-center w-full max-w-md shadow-2xl border-2" style={{ borderColor: PRIMARY }}>
              ...
              <p className="text-gray-600 text-sm mb-6">
                Thank you for submitting your AS Seapop DANCE CHALLENGE UGC entry details.
              </p>
              <button
                onClick={() => {
                  setShowModal(false);
